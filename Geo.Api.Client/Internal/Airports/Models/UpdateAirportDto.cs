...
internal sealed class UpdateAirportDto
{
    public UpdateAirportDto(int cityId, string name, string iataEn, double latitude, double longitude, string timezone, string osm)
    {
        CityId = cityId;
        Name = name;
        IataEn = iataEn;
