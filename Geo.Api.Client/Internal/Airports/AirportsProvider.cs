...
using Geo.Api.Client.Internal.Airports.Models;
using Geo.Api.Client.Models;
using Geo.Api.Client.Models.Airports;
using Geo.Api.Client.Providers;

namespace Geo.Api.Client.Internal.Airports;

internal sealed class AirportsProvider : IAirportsProvider
{
    private readonly HttpClient httpClient;

    public AirportsProvider(HttpClient httpClient)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await httpClient.GetAsync($"airport/{request.Id.Value}", cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var uri =
            $"search_objects/avia?query={query}&page_number={request.PageNumber}&page_size={request.PageSize}";
